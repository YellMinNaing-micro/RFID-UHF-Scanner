...
const styles = StyleSheet.create({
    ...
    oldPrice: { fontSize: 14, color: "#9CA3AF", textDecorationLine: "line-through", marginRight: 8 },
    discountBadge: { backgroundColor: "#EC4899", paddingHorizontal: 6, paddingVertical: 2, borderRadius: 12 },
    ...
    promoBox: { flexDirection: "row", alignItems: "center", backgroundColor: "#FECACA", padding: 8, borderRadius: 12, marginBottom: 16 },
