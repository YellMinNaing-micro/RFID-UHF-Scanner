...
const styles = StyleSheet.create({
    ...
    image: { width: "100%", height: 150, borderTopLeftRadius: 16, borderTopRightRadius: 16 },
    newBadge: {
        position: "absolute",
        top: 8,
        right: 8,
    ...
    cardContent: { padding: 8, backgroundColor: "#F3F4F6", borderRadius: 16, marginTop: 8 },
    ...
    logoutDialog: { backgroundColor: "#fff", padding: 16, borderRadius: 16, width: "80%", alignItems: "center" },
